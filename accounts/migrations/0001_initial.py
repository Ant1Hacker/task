# Generated by Django 4.0.3 on 2022-03-28 17:57
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[('FB', 'Facebook'), ('LI', 'LinkedIn'), ('GH', 'GitHub')], default='FB', max_length=255)),
        ...
        migrations.CreateModel(
            name='EducationAndEmploymentHistory',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[('ED', 'Education'), ('EM', 'Employment')], default='ED', max_length=255)),
                ('title', models.CharField(max_length=255)),
